...
export default function ProfileView() {
  ...
  if (loading) return <div className="profile-view"><div className="profile-skeleton" /></div>;
        ...
        <div className="profile-hero">
          ...
          <div className="profile-hero-info">
            ...
            <div className="profile-stats">
              <div className="pstat"><span className="pstat-num">{counts.listings}</span><span className="pstat-label">Publicaciones</span></div>
              <div className="pstat"><span className="pstat-num">{counts.purchases}</span><span className="pstat-label">Compras</span></div>
            </div>
          </div>
        </div>
